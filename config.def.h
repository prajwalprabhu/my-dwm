...
static const char *tagsalt[] = { "dev", "2", "3", "4", "5", "6", "7", "8", "9" };
...
static const char *termcmd[]  = { "termite","st", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_r,      spawn,          SHCMD("termite -e ranger")},
	{ ControlMask|ShiftMask,        XK_Escape, spawn,          SHCMD("termite -e bashtop")},
